...
export const getSchemas = () => [
  { id: '9708fa76-001c-4fe2-8a1f-b1b5099f5199', name: 'SENASICA BUMA GLOBAL GAGLOBALB GLOBAL GLOBAL', version: '1.2', description: 'Design Patterns is a library with its code with a lightweight 3D library for transferring data fetching. VueJS is a high-level.  VueJS is a.' },
